...
$config = array (
	...
	'components' => array(
		...
		'widget_settings' => array (
			...
			'after_widget' => '</div>',
			'before_title' => '<div class="widget-title"><div class="righttitle">',
			'after_title' => '</div></div>',
		),
			...
			array(
				...
				'options' => array(
					...
					array(	'name' => __('Background','academy'),
							...
							'id' => 'background',
							'type' => 'uploader'),
                    array(    'name' => __('About Course','academy'),
                            'desc' => __('About Course.','academy'),
                            'id' => 'about_course',
                            'type' => 'textarea'),
                    array(    'name' => __('Course Tabs','academy'),
                            'desc' => __('Course Tabs','academy'),
                            'id' => 'course_tabs',
                            'type' => 'textarea'),
                    array(    'name' => __('Course Testimonials','academy'),
                            'desc' => __('Course Testimonials','academy'),
	...
	'options' => array (
        ...
        array(    'name' => __('Facebook Page URL','academy'),
                'description' => __('Enter the facebook page url.','academy'),
                'id' => 'fb_url',
                'default' => '',
                'type' => 'text'),
        array(    'name' => __('Twitter Page URL','academy'),
                'description' => __('Enter the Twitter page url.','academy'),
                'id' => 'tw_url',
                'default' => '',
                'type' => 'text'),
        array(    'name' => __('Linkedin Page URL','academy'),
                'description' => __('Enter the Linkedin page url.','academy'),
                'id' => 'link_url',
                'default' => '',
                'type' => 'text'),
        array(    'name' => __('Google Page URL','academy'),
                'description' => __('Enter the Google page url.','academy'),
                'id' => 'google_url',
                'default' => '',
                'type' => 'text'),
		...
		array(	'name' => __('Header','academy'),
            ...
            array(    'name' => __('Student Sign In Link','academy'),
                    'description' => __('Enter the Student Sign In URL.','academy'),
                    'id' => 'student_signin_url',
                    'default' => '',
                    'type' => 'text'),
            array(    'name' => __('Faculty/Admin Sign In Link','academy'),
                    'description' => __('Enter the Faculty/Admin Sign In URL.','academy'),
                    'id' => 'admin_signin_url',
                    'default' => '',
                    'type' => 'text'),
		...
		array(	'name' => __('Courses','academy'),
            ...
            /* editted by atif   */
            array(    'name' => __('Sign Up Link','academy'),
                'id' => 'course_signup_link',
                'default' => '',
                'description' => __('To enter the sign up button link.','academy'),
                'type' => 'text' ),
            
            array(    'name' => __('Learn More Link','academy'),
                'id' => 'course_learnmore_link',
                'default' => '',
                'description' => __('To enter the learn more button link.','academy'),
                'type' => 'text' ),
        /* editted by atif   */    
