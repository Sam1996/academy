...
class ThemexWoo {
	...
	public static function filterFields($fields) {
		...
		self::$data['billing_address']=true;
		self::$data['billing_city']=true;
		self::$data['billing_postcode']=true;
		self::$data['billing_state']=true;
		self::$data['billing_country']=true;
		self::$data['billing_phone']=true;
