...
<style type="text/css">
	...
	.woocommerce header.title h3{font-size: 1.4em;}
</style>
...
?>
	...
	<?php else : ?>
		...
		<h3 style="font-size:22px"><?php echo do_shortcode("[wp2moodle class='button' cohort='']Click here to access your course[/wp2moodle]");
			?>
			<br><br>
		<!-- end of Mihir moodleofindia 15th sept 2014-->
		...
		<ul class="order_details" style="font-size:16px">
			<li class="order">
